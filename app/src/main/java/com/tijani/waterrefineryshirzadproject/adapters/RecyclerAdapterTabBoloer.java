...
public class RecyclerAdapterTabBoloer extends RecyclerView.Adapter<RecyclerAdapterTabBoloer.MyViewHolder> {

    Context context;
    List<TitleKarkardBoloerYaPomp> mData;

    public RecyclerAdapterTabBoloer(Context context, List<TitleKarkardBoloerYaPomp> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
        v= LayoutInflater.from(context).inflate(R.layout.item_recycler_tab_boloer,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.imgGoDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ActivityShowDetailsTabBoloer.class);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            txvTitle=itemView.findViewById(R.id.txv_boloer_recycler_item_tab_boloer);
            imgGoDetails=itemView.findViewById(R.id.img_goDetails_recycler_item_tab_boloer);
