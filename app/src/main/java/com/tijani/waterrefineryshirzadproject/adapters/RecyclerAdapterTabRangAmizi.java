...
public class RecyclerAdapterTabRangAmizi extends RecyclerView.Adapter<RecyclerAdapterTabRangAmizi.MyViewHolder> {

    Context context;
    List<AverageResultProperties> mData;

    public RecyclerAdapterTabRangAmizi(Context context, List<AverageResultProperties> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v;
        v= LayoutInflater.from(context).inflate(R.layout.item_recycler_tab_rang_amizi,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.imgGoDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ActivityShowDetailsTabRangAmizi.class);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            txvDate=itemView.findViewById(R.id.txv_date_recycler_item_tab_rangAmizi);
            imgGoDetails=itemView.findViewById(R.id.img_goDetails_recycler_item_tab_rangAmizi);
