...
public class ActivityShowListNegahdariVaTamiratBarq extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_list_negahdari_va_tamirat_barq);
        recyclerView=findViewById(R.id.recycler_negahdariVaTamirBarq);

        showNegahdariVaTamiratBarq();
    }

    private void showNegahdariVaTamiratBarq(){
        ...
        averageResultAdapter =  new AverageResultAdapter(ActivityShowListNegahdariVaTamiratBarq.this,averageResultPropertiesArrayList);
        recyclerView.setLayoutManager(new GridLayoutManager(ActivityShowListNegahdariVaTamiratBarq.this,1));
        ...
        averageResultAdapter.setOnItemClickListener(new AverageResultAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(G.context, ActivityShowDetilsNegahdariVaTamirBarq.class);
