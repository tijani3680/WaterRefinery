...
public class ActivityShowDetilsNegahdariVaTamirBarq extends AppCompatActivity {

    String url = Urls.urlReadNegahdariVaTamirBarq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_detils_negahdari_va_tamir_barq);
        progressBar = findViewById(R.id.progressbarActivityShowDtilsNegahdariVaTamirBarq);
        txvDate = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_date);
        txvNameTajhiz = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_nameTajhiz);
        txvlocationEsteqrar = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_locationEsteqrar);
        txvMadool = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_madool);
        txveeybeVaEllateEybe = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_eeybeVaEllateEybe);
        txvTypeActivity = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_typeActivity);
        txvDescribtionActivity = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_describtionActivity);
        txvQeteMasrafi = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_qeteMasrafi);
        txvNumberQeteMasrafi = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_numberQeteMasrafi);
        txvAfradYaSherekatAnjamDahandeh = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_afradYaSherekatAnjamDahandeh);
        txvNumberAfrad = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_numberAfrad);
        txvPriceQete = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_priceQete);
        txvPriceNiroyeEnsani = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_priceNiroyeEnsani);
        txvPriceTamirKharejAzKargah = findViewById(R.id.txv_activity_show_detils_negahdariVaTamirBarq_priceTamirKharejAzKargah);
