...
public class ActivityShowListMaqadirLajan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_list_maqadir_lajan);
        recyclerView=findViewById(R.id.recycler_maqadirLajan);
        showMaqadirLajan();
    }

    private void showMaqadirLajan(){
        ...
        averageResultAdapter =  new AverageResultAdapter(ActivityShowListMaqadirLajan.this,averageResultPropertiesArrayList);
        recyclerView.setLayoutManager(new GridLayoutManager(ActivityShowListMaqadirLajan.this,1));
        ...
        averageResultAdapter.setOnItemClickListener(new AverageResultAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(G.context, ActivityShowDetilsMaqadirLajan.class);
