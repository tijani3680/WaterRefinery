...
public class ActivityNegahdariVaTamiratBarq extends AppCompatActivity {

    String url = Urls.urlSabtNegahdariVaTamiratBarq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_negahdari_va_tamirat_barq);

        progressBar = findViewById(R.id.progressbarActivityNegahdariVaTamirBarqVaAbzarDaqiq);
        imgCalander = findViewById(R.id.img_activityNegahdariVaTamirBarqVaAbzarDaqiq_calendar);
        txvDate = findViewById(R.id.txv_activityNegahdariVaTamirBarqVaAbzarDaqiq_date);
        btnSabt = findViewById(R.id.btn_activityNegahdariVaTamirBarqVaAbzarDaqiq_sabt);
        edtNameTajhiz = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_nameTajhiz);
        edtLocationEsteqrar = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_locationEsteqrar);
        edtMadool = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_maadool);
        edtEeybeVaEllateEybe = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_eeybVaEllateEeybe);
        edtTypeActivity = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_typeActivity);
        edtDescribtionActivity = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_describtionActivity);
        edtQeteMasrafi = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_qateeMasrafi);
        edtNumberQeteMasrafi = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_numberQateeMasrafi);
        edtAfradYaSherekatAnjamDahandeh = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_afradYaSherekatAnjamDahandeh);
        edtNumberAfrad = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_numberNafarat);
        edtPriceQate = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_priceQatee);
        edtPriceNiroyeEnsani = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_priceNiroyeEnsani);
        edtPriceTamirKharejAzKargah = findViewById(R.id.edt_activityNegahdariVaTamirBarqVaAbzarDaqiq_priceTamirKharejAzKargah);
        ...
        btnSabt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (date.isEmpty()) {
                    Toast.makeText(ActivityNegahdariVaTamiratBarq.this, "تاریخ انتخاب نشده است!", Toast.LENGTH_SHORT).show();
                } else{
    ...
    public void sendData(final String date, final String nameTajhiz, final String locationEsteqrar, final String madool, final String eeybeVaEllateEybe, final String typeActivity, final String describtionActivity, final String qeteMasrafi, final String numberQeteMasrafi, final String afradYaSherekatAnjamDahandeh, final String numberAfrad, final String priceQate, final String priceNiroyeEnsani, final String priceTamirKharejAzKargah) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(ActivityNegahdariVaTamiratBarq.this, response.trim().toString(), Toast.LENGTH_SHORT).show();
